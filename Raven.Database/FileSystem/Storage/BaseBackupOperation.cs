        ...
        public void Execute()
        {
            try
            {
                ...
                if (filesystemDocument != null)
					File.WriteAllText(Path.Combine(backupDestinationDirectory, Constants.FileSystem.BackupDocumentFileName), RavenJObject.FromObject(filesystemDocument).ToString());
