    ...
    fillRow(rowData: documentBase, rowIndex: number) {
        ...
        if (rowAtIndex) {
			...
			if (rowData instanceof counterSummary) {
				editUrl = appUrl.forEditCounter(appUrl.getResource(), rowData[counterSummary.groupNameField], rowData[counterSummary.counterNameField]);
    ...
    editLastSelectedItem() {
        ...
        if (selectedItem) {
			...
			if (selectedItem instanceof counterSummary) {
                editUrl = appUrl.forEditCounter(appUrl.getResource(), selectedItem[counterSummary.groupNameField], selectedItem[counterSummary.counterNameField]);
