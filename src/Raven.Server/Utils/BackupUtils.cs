...
internal static class BackupUtils
{
        ...
        ServerStore serverStore)
    {
        ...
        databaseConfiguration ??= DatabasesLandlord.CreateConfiguration(serverStore.Configuration, databaseName, rawRecord.Settings);

        return new CurrentResponsibleNodeNotResponding(newResponsibleNode, lastResponsibleNode, databaseConfiguration.Backup.MoveToNewResponsibleNodeGracePeriod.AsTimeSpan);
    }
